...
API_ID = int(os.getenv('API_ID', '0'))  # ← ТОЛЬКО 0 ИЛИ ПУСТОЕ ЗНАЧЕНИЕ!
...
# === БЕЗОПАСНЫЕ ДАННЫЕ ===
# Эти данные можно оставить (они не секретные)

senders = {
    "huyznaet06@gmail.com": "cyeb pnyi ctpj xxdx",
    # ... остальные почты (это безопасно)
}

receivers = [
    'sms@telegram.org', 'dmca@telegram.org', 
