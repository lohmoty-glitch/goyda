...
api_hash = '   '
bot_token = 'token'
admin_chat_ids = ['id']  # Добавьте сюда ID всех администраторов 'id', 'id' и тд
CRYPTO_PAY_TOKEN = '332169:AABjHxC4snHVN4TYeIBIGLUlYdMZw3kmyPT' # тут замените на свой api от бота @send
